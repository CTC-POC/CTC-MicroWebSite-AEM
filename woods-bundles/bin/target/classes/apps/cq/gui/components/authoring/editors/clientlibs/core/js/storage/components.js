...
(function ($, ns, channel, window, undefined) {
     ...
     *
     * <p>Available on cq-components-loaded</p>
     *
     * @namespace
    ...
    ns.components = (function () {
         ...
         *
         * <p>Available on cq-components-filtered</p>
         *
         ...
         *
         * <p>Where the key is the path of an {@link Granite.author.Editable}</p>
         * <p>Available on cq-components-filtered</p>
         *
         * @memberof Granite.author.components
        ...
        self._findAllowedComponentsFromPolicy = function (editable, design) {
            var cell = resolve(design, editable.config.policyPath);
            ...
            if (!cell || !cell.components) {
                ...
                while (parent && !(cell && cell.components)) {
                    cell = resolve(design, parent.config.policyPath);
                ...
                if (editable.config.policyPath) {
                    ...
                    if (cellSearchPaths) {
                        for (var i = 0; i < cellSearchPaths.length; i++) {
                            var cell = resolve(design, cellSearchPaths[i]);
        ...
        self.computeAllowedComponents = function (editable, design) {
            ...
            if (allowed && allowed.length === 0 && editable.getParent()) {
                return self.computeAllowedComponents(editable.getParent(), design);
            }
