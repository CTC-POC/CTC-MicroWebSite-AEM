...
<div class="connect-content">
    <h3><%= i18n.get("LinkedIn Connect Configuration Settings") %></h3>

    <img src="<%=xssAttrWrap(xssAPI, currentNode.getProperty("thumbnailPath").getString())%>"
         alt="<%=i18n.get("Linkedin Connect")%>"
         title="<%=i18n.get("Linkedin Connect")%>"
         class="inIcon" />
 ...
 %>
        ...
        <%
            ...
            %>
                ...
                <% } %>
            <% } %>
            <li class="when-config-successful" style="display:none;"><%= i18n.get("LinkedIn Connect Configuration is successful. You can now use this with your <a href='{0}'>website</a>.", null, "/siteadmin")%></li>
        <% }else{ %>
