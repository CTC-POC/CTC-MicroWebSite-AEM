...
%><%@ page import="com.day.cq.wcm.foundation.TextFormat,
    ...
    final String name ="passportNumber";
    ...
    String title = i18n.getVar(FormsHelper.getTitle(resource, "Passport Number"));
...
Resource resparent = resource.getParent();
    ...
    %><input type="hidden" value="<%=required%>" id="passportNumberreq">
     <input type="hidden" value="<%=requiredMsg%>" id="passportNumberreqMesg">
<input type="hidden" value="<%=title%>" name="passportNumberLabel">
     <div class="form-group">
        <label for="passportNumber" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
        ...
        <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
            <input aria-labelledby="passportNumber" name="passportNumber" class="form-control custom-form-control" type="text" id="passportNumber">
 <% 
                if(tooltip!=null){
                %>  
