...
I18n i18n = new I18n(resourceBundle); 
    ...
    final String title = FormsHelper.getTitle(resource, i18n.get("Date Of Birth"));
...
%>
<input type="hidden" value="<%=required%>" id="DOBreq">
<input type="hidden" value="<%=requiredMsg%>" id="DOBreqMesg">
<input type="hidden" value="<%=title%>" name="dateOfBirthLabel">
    <div class="form-group">
        <label for="dateOfBirth" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
            <span class="asterisk-sign-clr">*</span>
            <%}%>
        </label>
        <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
          <input type="text" name="dateOfBirth" id="dateOfBirth" data-select="datepicker" class="form-control custom-form-control resetdate" readonly>
             <% 
                if(tooltip!=null){
                %>  
