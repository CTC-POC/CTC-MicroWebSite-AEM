...
%>
<input type="hidden" value="<%=required%>" id="arrivalDatereq">
<input type="hidden" value="<%=requiredMsg%>" id="arrivalDatereqMesg">
    <div class="form-group">
        <label for="arrivalDate" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
            <span class="asterisk-sign-clr">*</span>
            <%}%>
        </label>
      <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
          <input type="text" name="arrivalDate" id="arrivalDate"  class="form-control custom-form-control resetdate" readonly>
             <% 
                if(tooltip!=null){
                %>  
