...
final String tooltip=properties.get("tooltip",String.class);
    ...
    String title = i18n.getVar(FormsHelper.getTitle(resource, "Twitter"));
Resource resparent = resource.getParent();
    ...
    %><input type="hidden" value="<%=required%>" id="twitterreq">
<input type="hidden" value="<%=requiredMsg%>" id="twitterreqMesg">
<div class="form-group">
        <label for="Twitter" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
            ...
            <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
                <input aria-labelledby="Twitter" name="twitter" class="form-control custom-form-control" type="text" id="Twitter">
                <% 
                if(tooltip!=null){
                      %>  
