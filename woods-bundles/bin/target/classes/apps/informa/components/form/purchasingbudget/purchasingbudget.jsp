...
final String tooltip=properties.get("tooltip",String.class);
    ...
    %><input type="hidden" value="<%=required%>" id="purchasingbudgetreq">
<input type="hidden" value="<%=requiredMsg%>" id="purchasingbudgetreqMesg">
<div class="form-group">
        <label for="Purchasingbudget" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
            ...
            <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
                <input aria-labelledby="Purchasingbudget" name="purchasingBudget" class="form-control custom-form-control input-numbers" type="text" id="Purchasingbudget">
                 <% 
                if(tooltip!=null){
                      %>  
