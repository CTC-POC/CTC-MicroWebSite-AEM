...
%><%@ page import="com.day.cq.wcm.foundation.TextFormat,
    ...
    final String name ="passportPlaceOfIssue";
    ...
    String title = i18n.getVar(FormsHelper.getTitle(resource, "Passport Place Of Issue"));
...
Resource resparent = resource.getParent();
    ...
    %><input type="hidden" value="<%=required%>" id="passportPlaceOfIssuereq">
     <input type="hidden" value="<%=requiredMsg%>" id="passportPlaceOfIssuereqMesg">
<input type="hidden" value="<%=title%>" name="passportPlaceOfIssueLabel">
     <div class="form-group">
        <label for="passportPlaceOfIssue" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
        ...
        <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
            <input aria-labelledby="passportPlaceOfIssue" name="passportPlaceOfIssue" class="form-control custom-form-control" type="text" id="passportPlaceOfIssue">
 <% 
                if(tooltip!=null){
                %>  
