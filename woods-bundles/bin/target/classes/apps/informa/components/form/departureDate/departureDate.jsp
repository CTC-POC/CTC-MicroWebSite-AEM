...
%>
<input type="hidden" value="<%=required%>" id="departureDatereq">
<input type="hidden" value="<%=requiredMsg%>" id="departureDatereqMesg">
    <div class="form-group">
        <label for="departureDate" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo resetdate"><%=title%>
            <%if(required==true){%>
            <span class="asterisk-sign-clr">*</span>
            <%}%>
        </label>
       <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
          <input type="text" name="departureDate" id="departureDate" data-select="datepicker" class="form-control custom-form-control" readonly>
             <% 
                if(tooltip!=null){
                %>  
