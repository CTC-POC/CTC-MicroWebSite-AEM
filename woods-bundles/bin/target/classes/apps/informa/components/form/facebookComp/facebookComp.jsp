...
I18n i18n = new I18n(resourceBundle); 
    ...
    String title = i18n.getVar(FormsHelper.getTitle(resource, "Facebook"));
...
Resource resparent = resource.getParent();
    ...
    %><input type="hidden" value="<%=required%>" id="facebookreq">
	<input type="hidden" value="<%=requiredMsg%>" id="facebookreqMesg">

		<div class="form-group">
        <label for="facebook" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
            ...
            <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
                ...
                <!--<div class="col-md-12 paddingZero">-->
                    <input aria-labelledby="facebook" id="facebook" name="facebook" class="form-control custom-form-control reg-mobile-margin dep-fo1-mobile-margin" type="text">
                     <% 
                if(tooltip!=null){
                %>  
