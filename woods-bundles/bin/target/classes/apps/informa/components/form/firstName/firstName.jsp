...
%><%@ page import="com.day.cq.wcm.foundation.TextFormat,
    ...
    String title = i18n.getVar(FormsHelper.getTitle(resource, "First Name"));
...
Resource resparent = resource.getParent();
    ...
    %><input type="hidden" value="<%=required%>" id="firstNamereq">
     <input type="hidden" value="<%=requiredMsg%>" id="firstNamereqMesg">
   <input type="hidden" value="<%=title%>" name="firstNameLabel">
     <div class="form-group">
        <label for="FirstName" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
        ...
        <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
            <input aria-labelledby="FirstName" name="firstName" class="form-control custom-form-control" type="text" id="FirstName">
 <% 
                if(tooltip!=null){
                %>  
