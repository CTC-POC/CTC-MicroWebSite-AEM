...
I18n i18n = new I18n(resourceBundle);  
    ...
    final String name = "webaddressPersonal";
...
final String tooltip=properties.get("tooltip",String.class);
    ...
    String title = i18n.getVar(FormsHelper.getTitle(resource, "Web address Personal"));
Resource resparent = resource.getParent();
    ...
    %><input type="hidden" value="<%=required%>" id="webaddressPersonalreq">
<input type="hidden" value="<%=requiredMsg%>" id="webaddressPersonalreqMesg">
<div class="form-group">
        <label for="WebaddressPersonal" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
            ...
            <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
                <input aria-labelledby="WebaddressPersonal" name="webAddressPersonal" class="form-control custom-form-control" type="text" id="WebaddressPersonal">
                <% 
                if(tooltip!=null){
                      %>  
