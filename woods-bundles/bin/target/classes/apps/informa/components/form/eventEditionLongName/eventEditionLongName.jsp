...
I18n i18n = new I18n(resourceBundle);  
    ...
    final String name = "__EventEditionLongName";
...
final String tooltip=properties.get("tooltip",String.class);
    ...
    String title = i18n.getVar(FormsHelper.getTitle(resource, "Event Edition Long Name"));
        ...
        <div class="form_rightcol" id="<%= xssAPI.encodeForHTMLAttr(name) %>_rightcol"><%
            ...
            for (String value : values) {
                ...
                if (readOnly) {
                    ...
                    if (rows == 1) {
                        %><input placeholder="Event Edition Long Name" class="<%= FormsHelper.getCss(properties, "form_field form_field_text" + (multiValued ? " form_field_multivalued" : "" )) %>" <%
