...
I18n i18n = new I18n(resourceBundle); 
    ...
    final String name = "addressState";
...
final String tooltip=properties.get("tooltip",String.class);
    ...
    String title = i18n.getVar(FormsHelper.getTitle(resource, "Address State or County"));
    ...
    %><input type="hidden" value="<%=required%>" id="<%=addressClass%><%=addressType%>addressStatereq">
<input type="hidden" value="<%=requiredMsg%>" id="<%=addressClass%><%=addressType%>addressStatereqMesg">
<div class="form-group">
        <label for="AddressState" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
            ...
            <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
                <input aria-labelledby="AddressState" name="<%=addressClass%><%=addressType%>AddressState" class="form-control custom-form-control" type="text" id="AddressState">
                <% 
                if(tooltip!=null){
                      %>  
