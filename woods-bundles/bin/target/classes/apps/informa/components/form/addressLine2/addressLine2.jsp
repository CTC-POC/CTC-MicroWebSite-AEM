...
I18n i18n = new I18n(resourceBundle); 
    ...
    final String name ="addressLine2";
    ...
    String title = i18n.getVar(FormsHelper.getTitle(resource, "Address Line 2"));
    ...
    %><input type="hidden" value="<%=required%>" id="<%=addressClass%><%=addressType%>addressLine2req">
<input type="hidden" value="<%=requiredMsg%>" id="<%=addressClass%><%=addressType%>addressLine2reqMesg">
<div class="form-group">
        <label for="AddressTwo" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
            ...
            <!--<div class="col-md-12 paddingZero">-->
                <input aria-labelledby="AddressTwo" id="AddressTwo" name="<%=addressClass%><%=addressType%>AddressLine2" class="form-control custom-form-control reg-mobile-margin dep-fo1-mobile-margin" type="text">
                <% 
                if(tooltip!=null){
                %>  
