...
I18n i18n = new I18n(resourceBundle); 
    ...
    String title = i18n.getVar(FormsHelper.getTitle(resource, "Address Town/City"));
...
%><input type="hidden" value="<%=required%>" id="<%=addressClass%><%=addressType%>addresscityreq">
<input type="hidden" value="<%=requiredMsg%>" id="<%=addressClass%><%=addressType%>addresscityreqMesg">
<div class="form-group">
        <label for="AddressCity" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
           ...
           <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
                <input aria-labelledby="AddressCity" name="<%=addressClass%><%=addressType%>AddressCity" class="form-control custom-form-control" type="text" id="AddressCity">
                <% 
                if(tooltip!=null){
                      %>  
