...
I18n i18n = new I18n(resourceBundle); 
    ...
    final String name ="addressLine1";
    ...
    String title = i18n.getVar(FormsHelper.getTitle(resource, "Address Line 1"));
	...
	<input type="hidden" value="<%=required%>" id="<%=addressClass%><%=addressType%>addressLine1req">
	<input type="hidden" value="<%=requiredMsg%>" id="<%=addressClass%><%=addressType%>addressLine1reqMesg">

		<div class="form-group">
        <label for="AddressOne" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
            ...
            <%}%>
             ...
             <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
                <!--<div class="col-md-12 paddingZero">-->
                    <input aria-labelledby="AddressOne" id="AddressOne" name="<%=addressClass%><%=addressType%>AddressLine1" class="form-control custom-form-control reg-mobile-margin dep-fo1-mobile-margin" type="text">
                     <% 
                if(tooltip!=null){
                %>  
