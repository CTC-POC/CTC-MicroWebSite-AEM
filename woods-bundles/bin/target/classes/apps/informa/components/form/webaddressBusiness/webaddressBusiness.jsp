...
I18n i18n = new I18n(resourceBundle);  
    ...
    final String name = "webaddressBusiness";
...
final String tooltip=properties.get("tooltip",String.class);
    ...
    String title = i18n.getVar(FormsHelper.getTitle(resource, "Web address Business"));
Resource resparent = resource.getParent();
    ...
    %><input type="hidden" value="<%=required%>" id="webaddressBusinessreq">
<input type="hidden" value="<%=requiredMsg%>" id="webaddressBusinessreqMesg">
<div class="form-group">
        <label for="WebaddressBusiness" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
            ...
            <input aria-labelledby="WebaddressBusiness" name="webaddressBusiness" class="form-control custom-form-control" type="text" id="WebaddressBusiness">
                <% 
                if(tooltip!=null){
                      %>  
