...
I18n i18n = new I18n(resourceBundle);  
    ...
    final String name ="addressPObox";
    ...
    String title = i18n.getVar(FormsHelper.getTitle(resource, "Address PO box"));
    ...
    %><input type="hidden" value="<%=required%>" id="<%=addressClass%><%=addressType%>addressPOboxreq">
	<input type="hidden" value="<%=requiredMsg%>" id="<%=addressClass%><%=addressType%>addressPOboxreqMesg">
<div class="form-group">
        <label for="AddressPObox" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
            ...
            <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
                <input aria-labelledby="AddressPObox" name="<%=addressClass%><%=addressType%>AddressPOBox" class="form-control custom-form-control" type="text" id="AddressPObox">
                <% 
                if(tooltip!=null){
                      %>  
