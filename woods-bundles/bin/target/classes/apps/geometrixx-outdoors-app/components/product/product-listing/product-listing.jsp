...
%>
    <div class="responsive-cell product-menu-item" ng-click="goProduct('<%= request.getContextPath() %><%= xssAPI.getValidHref(templatePath) %>', '<%= xssAPI.getValidHref(productSKU) %>', '<%= xssAPI.encodeForJSString(product.getTitle()) %>')">
