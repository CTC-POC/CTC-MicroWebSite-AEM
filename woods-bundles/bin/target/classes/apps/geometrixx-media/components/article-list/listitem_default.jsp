        ...
        <div class="image-box">
            <a class="article-list-image-link" href="<%= pagePath + ".html" %>" title="<%= description %>">
                <div data-picture data-alt='<%= description %>'>
                    <div data-src='<%= pagePath + ".image.127.127.low." + extension %>'></div>
                    <div data-src='<%= pagePath + ".image.127.127.medium." + extension %>' data-media="(min-width: 320px)"></div>
                    <div data-src='<%= pagePath + ".image.256.192.high." + extension %>' data-media="(min-width: 980px)"></div>
                    <noscript>
                        <img src='<%= pagePath + ".image.127.127.low." + extension %>' alt='<%= description %>'>
                    </noscript>
                </div>
            </a>
        </div>
