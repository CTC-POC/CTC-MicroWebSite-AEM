...
%><%@include file="/libs/foundation/global.jsp"%><%
    ...
    if( renderType == null) {
        renderType = "geometrixx-outdoors/components/social/activitystreams/activity/renderers/default";
    }

    /* OVERRIDING RENDER TYPE */
    renderType = "geometrixx-media/components/social/forum/components/post/profile-comment";
    %>
        ...
        if(activity != null && activity.getObject() != null){
           ...
           if (values != null) {
            ...
            if (renderObjectType != null) {
               ...
               renderType = "geometrixx-outdoors/components/social/activitystreams/activity/" + localRenderType;
           } else {
             renderType = null;
           }
            return renderType;
