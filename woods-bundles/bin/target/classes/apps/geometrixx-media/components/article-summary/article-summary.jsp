        ...
        <div class="article-summary-image">
            <a href="<%= pagePath + ".html" %>">
                <div data-picture data-alt='<%= alt %>'>
                    <div data-src='<%= pagePath + ".image.320.150.medium." + extension %>' data-media="(min-width: 1px)"></div>
                    <div data-src='<%= pagePath + ".image.480.225.medium." + extension %>' data-media="(min-width: 321px)"></div> <%-- Mobile --%>
                    ...
                    <noscript>
                        <img src='<%= pagePath + ".image.320.150.low." + extension %>' alt='<%= alt %>'>
                    </noscript>
                </div>
            </a>
        </div>
