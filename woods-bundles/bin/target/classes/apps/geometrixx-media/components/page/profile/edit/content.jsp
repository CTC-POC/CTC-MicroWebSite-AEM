...
%><%@page session="false" import="com.adobe.granite.security.user.UserProperties,
										...
										<div class="row-fluid">
											...
											<div class="row-fluid">
												<div class="span9">
													<div class="text section">
														<div class="form_row">
															<cq:include path="left-par/city" resourceType="foundation/components/form/text"/>
															<!--<div class="form_leftcol">
																<div class="form_leftcollabel">
												...
												<div class="span3">
													<div class="dropdown section">
														<div class="form_row">
															<cq:include path="left-par/state" resourceType="foundation/components/form/dropdown"/>
															<!--<div class="form_leftcol">
																<div class="form_leftcollabel">
