...
<%
    ...
    final RequestParameter userIdParam = slingRequest.getRequestParameter("userId");
    if (userIdParam != null){
        hasParams = true;        
        userId = userIdParam.getString();
    }
...
<script>
    $CQ(function(){
        ...
        $CQ(".activity-load-more").click(function(event) {
            ...
            $CQ.ajax("<%= xssAPI.encodeForJSString(resource.getPath()) %>" + ".html?from="+from + "&count=" + to + "&userId=" + userId, {
