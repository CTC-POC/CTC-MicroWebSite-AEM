...
<%  
    ...
    final String divID = xssAPI.encodeForHTMLAttr("socialconnect" + uniqSuffix);
    
    final UserProperties currentUserProperties = slingRequest.getResourceResolver().adaptTo(UserProperties.class);
    final boolean isAnonymous = UserPropertiesUtil.isAnonymous(currentUserProperties);
        ...
        %>
            ...
            <div class="sidebar-content"><%
                ...
                if(facebookConfiguration != null){
                    ...
                    final String facebookProfilePath = currentUserProperties.getResource(".").getPath() + FACEBOOK;
                ...
                if(twitterConfiguration != null){
                    ...
                    final String twitterProfilePath = currentUserProperties.getResource(".").getPath() + TWITTER;
