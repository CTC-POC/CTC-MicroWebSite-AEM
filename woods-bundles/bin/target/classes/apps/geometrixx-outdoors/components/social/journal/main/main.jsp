...
%><%@include file="/libs/foundation/global.jsp"%><%
    ...
    if (journal.isEntry()) {
        %><cq:include path="../title" resourceType="geometrixx-outdoors/components/social/journal/entrytitle" /><%
        ...
        if (Journal.VIEW_NEW.equals(view)) {
            ...
            %><cq:include path="entries" resourceType="geometrixx-outdoors/components/social/journal/entrylist" /><%
        }
    }
