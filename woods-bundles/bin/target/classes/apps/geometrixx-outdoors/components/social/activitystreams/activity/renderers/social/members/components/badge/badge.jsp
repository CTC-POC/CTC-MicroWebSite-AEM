...
%>
        ...
        <div class="entries_content">
            ...
            <div class="desc">
                <p class="time border">
                    <span><%=xssAPI.encodeForHTML(author)%> <%=i18n.get("received a")%> Gold Badge (s)</span>
                    <span><%=DateFormat.getDateInstance(DateFormat.MEDIUM).format(activity.getPublished())%></span>
                </p>
                <p class="info"><strong><%=xssAPI.encodeForHTML(author)%></strong></p>
                <div class="badges">
                    <div class="gold">
                        <img src class="img22x22">
                        <div class="earned-badge">Gold Contributor (s)</div>
                    </div>
                </div>
            </div>
         </div>
