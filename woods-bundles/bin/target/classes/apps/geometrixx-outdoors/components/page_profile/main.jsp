    ...
    if (resources != null && resources.size() > 0) {
       //1 - we are in formchooser-mode, get the requested resource
        ...
        if( userResource != null) {
            ...
            String socialProfilePagePath = WCMUtils.getInheritedProperty(currentPage, resourceResolver, "cq:socialProfilePage");
            if (socialProfilePagePath == null || socialProfilePagePath.trim().length() == 0) {
                socialProfilePagePath = "/content/geometrixx-outdoors/en/user/account/social-profile";
            }
            socialProfileUrl = props.getNode().getPath() + ".form.html" + socialProfilePagePath;
        }
    }
