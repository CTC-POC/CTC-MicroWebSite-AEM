...
%><%
    ...
    final String tabRelativePath = basePath.substring(resourcePage.getContentResource().getPath().length()+1);
...
<div class="tabctrl-container">
    ...
    <% } %>
    <section id="reviews" class="tabctrl-content" data-path="ratings">        
        <cq:include path="<%= productUgcPath + "/jcr:content/reviews"%>" resourceType="social/reviews/components/hbs/reviews"/>
    </section>
</div><%!
