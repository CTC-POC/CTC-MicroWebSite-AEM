...
<%
    ...
    if (!list.isEmpty()) {
        ...
        while (items.hasNext()) {
            ...
            String extension = xssAPI.encodeForHTMLAttr(GeoHelper.getPageImageExtension(carouselPage));
            Slide slide = new Slide(carouselPage, contextPath, extension);
                            ...
                            <div class="article-summary-image">
                                <a href="${slide.path}.html">
                                    <div data-picture data-alt='${slide.title}'>
                                        <div data-src='${slide.path}.image.370.150.medium.${slide.extension}' data-media="(min-width: 1px)"></div>
                                        <div data-src='${slide.path}.image.480.190.medium.${slide.extension}' data-media="(min-width: 480px)"></div>
                                        <div data-src='${slide.path}.image.770.300.medium.${slide.extension}' data-media="(min-width: 768px)"></div>
                                        <div data-src='${slide.path}.image.940.340.high.${slide.extension}'   data-media="(min-width: 980px)"></div>
                                        <div data-src='${slide.path}.image.1170.400.high.${slide.extension}'  data-media="(min-width: 1199px)"></div>
                                        <noscript>
                                            <img src='${slide.path}.image.370.150.low.${slide.extension}' alt='${slide.title}'>
                                        </noscript>
                                    </div>
                                </a>
                            </div>
...
%><%!
    ...
    public static final class Slide {
        ...
        private Slide(Page page, String contextPath, String extension) {
            this.page = page;
            title = page.getTitle();
