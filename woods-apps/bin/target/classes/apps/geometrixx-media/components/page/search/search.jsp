...
%><div id="globalsearch">
    <form class="form-search" action="<%= xssAPI.getValidHref(home) %>/toolbar/search.html" method="get">
        <div class="sp-magnify"></div>
        <div id="sp-label">
            <input class="cq-auto-clear" type="text" name="q" value="<%= xssAPI.encodeForHTMLAttr(search.getQuery()) %>" id="sp-searchtext">
        </div>
    </form>
</div>
