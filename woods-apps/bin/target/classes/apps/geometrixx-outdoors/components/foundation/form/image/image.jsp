...
%>
        <div class="form_rightcol fake-file-upload"><input id="<%=id %>" class="<%= FormsHelper.getCss(properties, "form_field form_field_file") %>" name="<%= name %>" type="file" size="1"><button type="button" class="gray-box"><%= bundle.getString("Choose File") %></button> <div></div></div>
<%
    }
%>
    </div><%
