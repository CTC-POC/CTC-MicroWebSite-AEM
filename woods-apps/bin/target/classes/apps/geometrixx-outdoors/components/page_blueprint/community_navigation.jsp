...
%><%@ page contentType="text/html; charset=utf-8" import="
    ...
    final String communityPagePath = currentPage.getParent().getPath();
    Page rootPage = null;
    if(communityPagePath != null){
        rootPage = pm.getPage(communityPagePath);
    }
    if(rootPage == null){
        rootPage = currentPage.getAbsoluteParent(currentStyle.get("absParent", 4));;
    }
