<%@page session="false"%><%--
  ...
  ************************************************************************
  ...
  This component renders application-specific properties within a
  Classic UI catalog or section blueprint.  (A Touch-optimized rendering,
  in contrast, uses the cq:dialog defintion.)
