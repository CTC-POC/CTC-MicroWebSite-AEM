...
%>        <li class="topcoat-list__item">
            <a x-cq-linkchecker="skip" ng-click="go('<%= request.getContextPath() %><%= xssAPI.getValidHref(carouselPage.getPath()) %>', '<%= xssAPI.encodeForJSString(title) %>')"><%= xssAPI.encodeForHTML(title) %>
