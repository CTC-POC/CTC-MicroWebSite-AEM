...
final String tooltip=properties.get("tooltip",String.class);
    ...
    %><input type="hidden" value="<%=required%>" id="purchaseAmountreq">
<input type="hidden" value="<%=requiredMsg%>" id="purchaseAmountreqMesg">
<div class="form-group">
        <label for="PurchaseAmount" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
            ...
            <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
                <input aria-labelledby="PurchaseAmount" name="purchaseAmount" class="form-control custom-form-control input-numbers" type="text" id="PurchaseAmount">
                 <% 
                if(tooltip!=null){
                      %>  
