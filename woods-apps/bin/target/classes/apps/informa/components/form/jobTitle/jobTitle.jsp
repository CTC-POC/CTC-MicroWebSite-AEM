...
I18n i18n = new I18n(resourceBundle); 
    ...
    String title = i18n.getVar(FormsHelper.getTitle(resource, "Job Title"));
Resource resparent = resource.getParent();
    ...
    %><input type="hidden" value="<%=required%>" id="jobtitlereq">
   <input type="hidden" value="<%=requiredMsg%>" id="jobtitlereqMesg">
   <div class="form-group">
       <label for="JobTitle" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
           <%if(required==true){%>
		    ...
		    <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
               <input aria-labelledby="JobTitle" id="JobTitle" name="jobTitle" class="form-control custom-form-control" type="text">
                <% 
                if(tooltip!=null){
                %>  
