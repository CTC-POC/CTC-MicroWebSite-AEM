...
final String tooltip=properties.get("tooltip",String.class);
    ...
    %><input type="hidden" value="<%=required%>" id="<%=faxClass%>faxAreacodereq">
<input type="hidden" value="<%=requiredMsg%>" id="<%=faxClass%>faxAreacodereqMesg">
<div class="form-group">
        <label for="FaxAreacode" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
            ...
            <%}%>
             ...
             <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
                <input aria-labelledby="FaxAreacode" name="<%=faxClass%>FaxAreaCode" class="form-control custom-form-control input-numbers" type="text" id="FaxAreacode">
                <% 
                if(tooltip!=null){
                      %>  
