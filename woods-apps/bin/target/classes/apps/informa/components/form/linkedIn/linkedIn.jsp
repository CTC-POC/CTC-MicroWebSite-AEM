...
final String tooltip=properties.get("tooltip",String.class);
    ...
    String title = i18n.getVar(FormsHelper.getTitle(resource, "LinkedIn"));
Resource resparent = resource.getParent();
    ...
    %><input type="hidden" value="<%=required%>" id="linkedinreq">
<input type="hidden" value="<%=requiredMsg%>" id="linkedinreqMesg">

<div class="form-group">
        <label for="LinkedIn" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
            ...
            <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
                <input aria-labelledby="LinkedIn" name="linkedIn" class="form-control custom-form-control" type="text" id="LinkedIn">
                 <% 
                if(tooltip!=null){
                      %>  
