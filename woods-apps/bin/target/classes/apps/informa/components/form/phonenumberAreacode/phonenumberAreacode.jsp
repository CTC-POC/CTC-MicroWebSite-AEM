...
<input type="hidden" value="<%=required%>" id="<%=phoneClass%><%=phoneType%>phonenumberAreacodereq">
<input type="hidden" value="<%=requiredMsg%>" id="<%=phoneClass%><%=phoneType%>phonenumberAreacodereqMesg">
<div class="form-group">
        <label for="PhonenumberAreacode" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
            ...
            <input aria-labelledby="PhonenumberAreacode" name="<%=phoneClass%><%=phoneType%>PhoneNumberAreacode" class="form-control custom-form-control input-numbers" type="text" id="PhonenumberAreacode">
                 <% 
                if(tooltip!=null){
                      %>  
