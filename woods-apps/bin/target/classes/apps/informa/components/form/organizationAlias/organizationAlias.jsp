...
I18n i18n = new I18n(resourceBundle);  
    ...
    final String name = "organizationAlias";
    ...
    String title = i18n.getVar(FormsHelper.getTitle(resource, "Organization Alias"));
Resource resparent = resource.getParent();
    ...
    %><input type="hidden" value="<%=required%>" id="organizationAliasreq">
   <input type="hidden" value="<%=requiredMsg%>" id="organizationAliasreqMesg"><div class="form-group">
        <label for="OrganizationAlias" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
            ...
            <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
                <input aria-labelledby="OrganizationAlias" name="organizationAlias" class="form-control custom-form-control" type="text" id="OrganizationAlias">
                <% 
                if(tooltip!=null){
                %>  
