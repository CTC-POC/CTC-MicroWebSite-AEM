...
%>
<input type="hidden" value="<%=required%>" id="passportIssuedDatereq">
<input type="hidden" value="<%=requiredMsg%>" id="passportIssuedDatereqMesg">
<input type="hidden" value="<%=title%>" name="passportIssueLabel">
    <div class="form-group">
        <label for="passportIssuedDate" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
            <span class="asterisk-sign-clr">*</span>
            <%}%>
        </label>
        <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
          <input type="text" name="passportIssuedDate" id="passportIssuedDate" data-select="datepicker" class="form-control custom-form-control resetdate" readonly>
             <% 
                if(tooltip!=null){
                %>  
