...
I18n i18n = new I18n(resourceBundle);
    ...
    final String name = "phonenumberbasenumber";
    ...
    String title = i18n.getVar(FormsHelper.getTitle(resource, "Phone number base number"));
...
ValueMap parentProps = resource.getParent().getValueMap();
    ...
    %><input type="hidden" value="<%=required%>" id="<%=phoneClass%><%=phoneType%>phonenumberbasenumberreq">
<input type="hidden" value="<%=requiredMsg%>" id="<%=phoneClass%><%=phoneType%>phonenumberbasenumberreqMesg">
<div class="form-group">
        <label for="Phonenumberbasenumber" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
            ...
            <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
                <input aria-labelledby="Phonenumberbasenumber" name="<%=phoneClass%><%=phoneType%>PhoneNumberBaseNumber" class="form-control custom-form-control input-numbers" type="text" id="Phonenumberbasenumber">
                 <% 
                if(tooltip!=null){
                %>  
