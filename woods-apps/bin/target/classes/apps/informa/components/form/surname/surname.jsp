...
I18n i18n = new I18n(resourceBundle);  
 ...
 String tooltip=properties.get("tooltip",String.class);
    ...
    String title = i18n.getVar(FormsHelper.getTitle(resource, "Surname"));
    ...
    %><input type="hidden" value="<%=required%>" id="surnamereq">
<input type="hidden" value="<%=requiredMsg%>" id="surnamereqMesg">
<input type="hidden" value="<%=title%>" name="surnameLabel">
       <div class="form-group ">
       <label for="LastName" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo" ><%=title%>
          <%if(required==true){%>
           ...
           <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
            <input aria-labelledby="LastName" id="LastName" name="surname" class="form-control custom-form-control" type="text">
			 <% 
              if(tooltip!=null){
               %>  
