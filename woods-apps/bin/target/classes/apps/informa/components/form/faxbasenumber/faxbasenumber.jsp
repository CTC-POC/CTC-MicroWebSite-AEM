...
I18n i18n = new I18n(resourceBundle);  
    ...
    final String name ="faxbasenumber";
...
final String tooltip=properties.get("tooltip",String.class);
    ...
    String title = i18n.getVar(FormsHelper.getTitle(resource, "Fax base number"));
    ...
    %><input type="hidden" value="<%=required%>" id="<%=faxClass%>faxbasenumberreq">
<input type="hidden" value="<%=requiredMsg%>" id="<%=faxClass%>faxbasenumberreqMesg">
<div class="form-group">
        <label for="Faxbasenumber" class="col-md-3 col-sm-3 form-one-control-label forms-title-color-fo"><%=title%>
            <%if(required==true){%>
            ...
            <div class="col-md-9 col-lg-7 col-sm-9 col-xs-11 input-div">
                <input aria-labelledby="Faxbasenumber" name="<%=faxClass%>FaxBaseNumber" class="form-control custom-form-control input-numbers" type="text" id="Faxbasenumber">
                <% 
                if(tooltip!=null){
                      %>  
