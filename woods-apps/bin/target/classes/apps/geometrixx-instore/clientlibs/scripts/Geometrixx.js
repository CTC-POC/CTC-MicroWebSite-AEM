...
define('Geometrixx', [
    'underscore',
    'jquery',
    'geometrixx/models/app',
    'geometrixx/collections/catalogs',
    'views/BaseView',
    'ux/views/SwipeGridView',
    'geometrixx/views/logo',
    'geometrixx/views/catalog'
    ...
    var Geometrixx = BaseView.extend(/** @lends Geometrixx.prototype */ {
        ...
        constructor: function(options) {
            ...
            Geometrixx.__super__.constructor.apply(this, arguments);
        },
         ...
         * Destroy the view.
         *
         * @returns {Geometrixx} the destroyed view
         */
        destroy: function() {
            if (this._views) {
                this._views = null;
            ...
            return Geometrixx.__super__.destroy.apply(this, arguments);
        },
